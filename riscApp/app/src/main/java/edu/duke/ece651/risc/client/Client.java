...
public class Client extends Thread{
  ...
  public boolean chooseRegions() {
    ...
    try {
      ...
      while (true) {
        ...
        // Output board
        clientOutput.displayString("Got to the board");
  ...
  public void playGame() {
    ...
    try {
      ...
      clientOutput.displayString("Successfully connected, you are named: " + player.getName() + "Please wait for more players to connect");
