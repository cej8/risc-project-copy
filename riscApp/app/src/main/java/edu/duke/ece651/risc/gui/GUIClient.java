...
//            GUIClientLogin clientLogin = new GUIClientLogin(model.getRegistrationAlert(),connection, clientInput, ParentActivity.getClientOutput(), ParentActivity.getActivity());
