...
public class ParentServerTest {
  ...
  public void test_assorted(){
    ...
    try{
      ...
      assertEquals(ps.getChildren().get(0).getPlayer().getName(), cs.get(0).getPlayer().getName());
      assertEquals(ps.getChildren().get(0).getParentServer(), cs.get(0).getParentServer());
      ...
      assertEquals(ps.playersLeft().iterator().next().getName(), ps.getChildren().get(0).getPlayer().getName());
  ...
  public void test_orders(){
    ...
    orders.add(new MoveOrder(regions.get(regions.size()-1), regions.get(0), new Unit(regions.size())));
    ...
    for(int j = 0; j < 5; j++){
      ...
      assert(!ps.getBoard().getRegions().get(1).getOwner().getName().equals("Group A"));
