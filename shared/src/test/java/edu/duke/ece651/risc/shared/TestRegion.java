...
public class TestRegion {
  ...
  public void test_Region() {
    ...
    assertEquals(7, regionList.get(0).getFuelProduction());
    assertEquals(2, regionList.get(0).getTechProduction());
    
    regionList.get(0).setFuelProduction(1222222);
    assertEquals(1222222, regionList.get(0).getFuelProduction()); 
