...
public class ValidatorTest {
  ...
  public void test_RegionValidator() {
    ...
    AttackOrder attack13 = new AttackOrder(r1, r3, new Unit(4));// valid adjacent
    AttackOrder attack23 = new AttackOrder(r2, r3, new Unit(3));// invalid not adjacent
    AttackOrder attack36 = new AttackOrder(r3, r6, new Unit(2));// invalid same owner
